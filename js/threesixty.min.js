    ...
    a.ThreeSixty = function (b, c) {
        ...
        e.$el = a(b), e.el = b, e.$el.data("ThreeSixty", e), e.init = function () {
            ...
            e.$el.bind("mousedown touchstart touchmove touchend mousemove click", function (a) {
                a.preventDefault(),
                a.originalEvent.changedTouches.length < 2?"mousedown" === a.type && 1 === a.which || "touchstart" === a.type
                    ? (d.pointerStartPosX = e.getPointerEvent(a).pageX, d.dragging = !0, d.onDragStart(d.currentFrame))
                    : "touchmove" === a.type
                    ? (a.originalEvent.touches.length<=1?e.trackPointer(a):void 0)
                    : "touchend" === a.type && (d.dragging = !1, d.onDragStop(d.endFrame)):void 0
